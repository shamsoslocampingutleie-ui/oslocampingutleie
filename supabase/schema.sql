...
-- Security fix: listings had no field-protection trigger at all, and
...
-- stripe-boost webhook flow, and rating/reviews_count are meant to be a
-- computed reflection of real reviews -- but any listing owner could
-- otherwise PATCH these directly, bypassing payment for boost placement
-- or faking review stats. (featured is intentionally free and
-- host-toggleable, left untouched.) Found missing from this file
-- during a schema.sql/live-DB drift audit -- it was already live via
-- 20260913190200_protect_listing_boost_and_rating.sql, just never
-- backfilled here.
...
-- ============================================================
-- WORKING REFERRAL PROGRAM (2026-09-25)
-- ============================================================
-- See migrations/20260925240000_working_referral_program.sql.
